...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "Priyanshuranjanjha401@gmail.com" },
    { icon: Phone, label: "Phone", value: "+91 9179196208" },
    { icon: MapPin, label: "Location", value: "Bhopal, Madhya Pradesh, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/priyanshuBABA" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/priyanshu-ranjan-8bb51b2a7?utm_source=share_via&utm_content=profile&utm_medium=member_android" },
    { icon: Mail, url: "mailto:Priyanshuranjanjha401@gmail.com" },
    { icon: MessageCircle, url: "https://wa.me/+919179196208" },
    { icon: Instagram, url: "https://www.instagram.com/vlog_with_baba?igsh=YnMza2UycXI3d240" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="mb-8 overflow-hidden rounded-3xl shadow-2xl w-full h-64 md:h-80 border-2 border-white/20">
              <img src="/new-photo-3.jpg" alt="Profile" className="w-full h-full object-cover object-center hover:scale-105 transition-transform duration-500" />
            </div>
